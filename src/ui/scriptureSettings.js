...
export const PRESETS = [
    {
        id: 'preset-4parts',
        name: '성경 통독',
        desc: '매일 4장씩 — 구약·신약을 4갈래로 함께 읽어요. 1년에 한 번 통독.',
        parts: [1, 2, 3, 4],
    },
    {
        id: 'preset-ot-three',
        name: '구약 통독',
        desc: '매일 3장씩 — 구약을 차근차근. 신약은 잠시 쉬어가요.',
        parts: [1, 2, 3],
    },
    {
        id: 'preset-newtestament',
        name: '신약 통독',
        desc: '매일 1장씩 — 신약 27권만. 복음서부터 계시록까지 짧게.',
        parts: [4],
    },
    {
        id: 'preset-poetry',
        name: '시가서 묵상',
        desc: '매일 1장씩 — 욥기·시편·잠언·전도서·아가. 시와 지혜에 머물 때.',
        parts: [1],
    },
    {
        id: 'essentials100',
        name: '100구절',
        desc: '하루 한 구절씩 — 한국 교회 핵심 100구절. 묵상 처음이거나 짧게 머물 때 좋아요.',
        parts: [1, 4],
    },
];
