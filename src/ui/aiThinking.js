...
export const THINKING_COPY = {
    ...
    profileBootstrap: [
        // (2026-05-16 fix) 흐름 순서대로 — 답을 먼저 살피고 → 정리하고 → 다음 질문 다듬기
        '답변 살피는 중...',
        '정리하는 중...',
        '다음 질문 다듬는 중...',
    ],
    // (2026-05-18 후속) 맨 처음 질문 — 사용자가 답을 안 한 상태라 "살피는 중" 부자연.
    //   SWAN 깨우러 가는 톤 풀 (랜덤). 두 번째 질문부터는 위 profileBootstrap 자연 사용.
    profileBootstrapFirst: [
        'SWAN 침대에서 깨우는 중...',
        'SWAN 집에서 데려오는 중...',
        'SWAN 커피 한 잔 하는 중...',
        'SWAN 호텔 조식 먹는 중...',
