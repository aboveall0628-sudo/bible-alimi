...
function swanBubbleHTML(message) {
    return `
      <div class="onboarding-swan-bubble onboarding-swan-bubble-typing" data-swan-typing>
        <span class="onboarding-swan-icon" aria-hidden="true">
...
// ─── Step 10 (v105): 오늘의 목표 — 2단계 2026-05-18 / v105 카피 갈아끼움 ───
// 사용자 명시 (2026-05-20): "묵상의 결단 → 오늘의 목표로 가야"
function renderCommitmentStep(body) {
    body.innerHTML = `
      <div class="onboarding-card">
        ${swanBubbleHTML('오늘의 목표를 적어볼까요?')}
...
// 사용자 명시 (2026-05-20): "오늘의 시간표가 나와야"
