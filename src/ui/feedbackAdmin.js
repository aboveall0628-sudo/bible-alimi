...
import { fireFeedbackNotification } from './notifications.js';
                    ...
                    if (createdMs > sessionStart) {
                        ...
                        if (!localStorage.getItem(firedKey)) {
                            ...
                            const summaryText = data.summary || 
                                (data.turns?.find(t => t.role === 'user')?.text?.slice(0, 60)) || 
                                '새로운 의견이 도착했어요.';
                            ...
                            }).catch(err => console.warn('[feedbackBadge] notification fire failed:', err));
                        }
                    }
                }
            });
